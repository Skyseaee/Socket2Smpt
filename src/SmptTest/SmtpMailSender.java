...
public final class SmtpMailSender
{
        ...
        try {
            if(addressee!=null) {
                if(addressee.length()==0) {
                    ...
                    addressee=addressee.substring(1,addressee.length()-1).trim(); // 处理收件人姓名，去掉两端的双引号
                }
            }
            ...
            sendString("EHLO "+parseUrl(senderAddress),out);
            sendNewline(out);
    ...
    private String[] parseDomain(String url) {
        try {
            ...
            if(records.hasMore()) {
                ...
                //  System.out.println("parseUrl2:" + url); 30 mx1.qq.com., 10 mx3.qq.com., 20 mx2.qq.com.
                ...
                //  System.out.println("parseUrl3:" + tmpMx[0] + tmpMx[1]); 30mx1.qq.com.
    ...
    private void log(String info) {
        for (LogManager manager : logManager) {
            manager.output(info);
        }
    }
